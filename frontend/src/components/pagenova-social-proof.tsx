...
const testimonials = [
  {
    ...
    text: "Ter criação, edição e organização no mesmo ambiente deixa o processo muito mais direto.",
  },
  {
    ...
    text: "O fluxo reúne as principais etapas para trabalhar uma landing page sem espalhar tudo em várias ferramentas.",
  },
  {
    ...
    text: "A proposta de começar uma página e continuar os ajustes dentro do mesmo fluxo facilita bastante o trabalho.",
  },
  {
    ...
    city: "Florianópolis, SC",
    role: "Social media",
    text: "Consigo estruturar a página e visualizar a oferta com muito mais rapidez durante a criação.",
  },
  {
    ...
    text: "Centralizar clonagem e edição torna muito mais simples preparar páginas para diferentes campanhas.",
  },
  {
    ...
    city: "Recife, PE",
    role: "Infoprodutora",
    text: "A interface é direta e ajuda a sair da ideia para uma página organizada sem complicar o processo.",
  },
  {
    ...
    city: "Campinas, SP",
    role: "Designer",
    text: "O editor visual deixa o ajuste da página muito mais prático para quem precisa trabalhar rápido.",
  },
  {
  ...
  },
  {
    ...
    city: "Salvador, BA",
    role: "E-commerce",
    text: "Ter um fluxo único para construir e ajustar landing pages reduz bastante o trabalho operacional.",
  },
];
